...
{{--    <link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.1.3/css/bootstrap.css">--}}
    <link rel="stylesheet" href="https://i02cxmjkxyar0t0.eu.qlikcloud.com/resources/autogenerated/qlik-styles.css">
...
<script type="text/javascript" src="https://i02cxmjkxyar0t0.eu.qlikcloud.com/resources/assets/external/requirejs/require.js"></script>
 ...
 */
    ...
    async function connect() {
        const urlQlikServer = "https://i02cxmjkxyar0t0.eu.qlikcloud.com/";
        ...
        return await fetch(`${urlQlikServer}${urlLoggedIn}`, {
            ...
            .then(async function(response)
            {
                ...
                if(response.status===401){
                    ...
                    url.searchParams.append('returnto', 'https://localhost:3000');
    ...
    var config1 = {
        host: "i02cxmjkxyar0t0.eu.qlikcloud.com", //the address of your Qlik Engine Instance
