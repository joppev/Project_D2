        ...
        DB::table('plannings')->insert(
            [
                [
                    ...
                    'isBezig' => true,
                    'isAfgewerkt' => false,
                    'startTijd' => DateTime::createFromFormat('Y-m-d H:i','2021-02-03 20:00'),
                ...
                [
                    ...
                    'isBezig' => false,
                    'isAfgewerkt' => false,
                    'startTijd' => DateTime::createFromFormat('Y-m-d H:i','2021-02-03 19:00'),
                    'stopTijd'  =>DateTime::createFromFormat('Y-m-d H:i','2021-02-03 20:00'),
                    'created_at' => now(),
                    'updated_at'=> now()
                ],
                [
                    ...
                    'isBezig' => false,
                    'isAfgewerkt' => false,
                    'startTijd' => DateTime::createFromFormat('Y-m-d H:i','2021-02-03 18:00'),
                    'stopTijd'  =>DateTime::createFromFormat('Y-m-d H:i','2021-02-03 19:00'),
                    'created_at' => now(),
                    'updated_at'=> now()
                ],
